...
**Strategy definition (`setOperation()`):** The context invokes the `setOperation()` method, dynamically injecting the instance of the corresponding concrete strategy (`Rectangle`, `Triangle`, `Diamond`).
